...
Avo.configure do |config|
  ...
  config.current_user_method do
    OpenStruct.new(id: cookies.encrypted[:github_user_id], name: "David Celis", avatar: "https://avatars.githubusercontent.com/u/#{cookies.encrypted[:github_user_id]}?v=4")
  end

  config.authenticate_with do
    unless cookies.encrypted[:github_user_id] == Rails.application.credentials.dig(:github, :user_id)
      redirect_to "/"
    end
  end
